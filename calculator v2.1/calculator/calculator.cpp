...
double calculator::read(queue<string> inputfrommain)
{
...
int calculator::level(string priority)
{
...
double calculator::js(double firstnum, double secondnum, string operators)
{
	if (strinput[0] == '+')
